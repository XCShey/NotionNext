...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'SFly', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '游戏里的航空飞行器制造商', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://sfly.thebxcshey.top', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '简单飞机,SP,sfly', // 网站关键词 英文逗号隔开
